...
def show_menu():
    ...
    def get_options():
        ...
        if is_installed("fail2ban"):
            options.extend([
                ...
                ("banned", "2. List Banned IPs"),
                ("unban", "3. Unban IP"),
                ("ban", "4. Ban IP Manually"),
                ("config", "5. Configure Ban Settings"),
                ("jails", "6. View Jail Status"),
            ])
        else:
    ...
    handlers = {
        ...
        "status": show_status,
        "banned": list_banned_ips_interactive,
        "unban": unban_ip_interactive,
        "ban": ban_ip_interactive,
        "config": configure_settings,
        "jails": view_jail_status_interactive,
    }
