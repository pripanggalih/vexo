# Node.js Monitoring Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add Node.js monitoring features including process stats, memory analysis, active connections, PM2 monit dashboard, and health check diagnostics.

**Architecture:** Create `modules/runtime/nodejs/monitor.py` with functions for monitoring Node.js processes and system resources.

**Tech Stack:** Python, PM2, system tools (ps, netstat, lsof)

**Dependency:** Requires `2025-01-15-nodejs-01-pm2.md` to be executed first (creates folder structure).

---

## Task 1: Create Monitoring Module

**Files:**
- Create: `modules/runtime/nodejs/monitor.py`
...
```bash
git add modules/runtime/nodejs/monitor.py
git commit -m "feat(runtime): add Node.js monitoring"
```
...
**Plan saved to:** `docs/plans/2025-01-15-nodejs-04-monitoring.md`

This plan covers:
- Process Stats (PM2 and raw Node.js processes)
- Memory Analysis (RSS, VSZ, recommendations)
- Active Connections (listening ports, TCP connections)
- PM2 Dashboard (interactive monit)
- Health Check (7-point diagnostics)

**Dependency:** Execute after `2025-01-15-nodejs-01-pm2.md`
