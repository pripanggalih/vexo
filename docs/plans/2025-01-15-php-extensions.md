# PHP Extension Management Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add comprehensive PHP extension management including listing, individual install/remove, enable/disable, PECL extensions, and detailed extension info.

**Architecture:** Create `modules/runtime/php/extensions.py` with functions for extension lifecycle management. Uses `apt` for standard extensions and `pecl` for PECL extensions.

**Tech Stack:** Python, apt package manager, pecl, phpenmod/phpdismod

**Dependency:** Requires `2025-01-15-php-fpm-management.md` to be executed first (creates folder structure).

---

## Task 1: Create Extension Management Module

**Files:**
- Create: `modules/runtime/php/extensions.py`
...
```bash
git add modules/runtime/php/extensions.py
git commit -m "feat(runtime): add PHP extension management"
```
...
**Plan saved to:** `docs/plans/2025-01-15-php-extensions.md`

This plan covers:
- List Extensions (with installed/loaded status)
- Install Single Extension
- Remove Extension
- Enable/Disable Extension (phpenmod/phpdismod)
- PECL Extensions (redis, swoole, xdebug, etc.)
- Extension Info (version, INI entries, SAPI status)
