# Node.js App Deployment Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add Node.js app deployment features including deployment wizard, nginx reverse proxy setup, environment variables management, and systemd service creation.

**Architecture:** Create `modules/runtime/nodejs/deploy.py` with functions for deploying Node.js apps with nginx integration and process management.

**Tech Stack:** Python, nginx, PM2/systemd, environment variables

**Dependency:** Requires `2025-01-15-nodejs-01-pm2.md` to be executed first (creates folder structure).

---

## Task 1: Create App Deployment Module

**Files:**
- Create: `modules/runtime/nodejs/deploy.py`
...
```bash
git add modules/runtime/nodejs/deploy.py
git commit -m "feat(runtime): add Node.js app deployment"
```
...
**Plan saved to:** `docs/plans/2025-01-15-nodejs-03-app-deployment.md`

This plan covers:
- Deploy New App (wizard with nginx + PM2/systemd)
- Configure Nginx Proxy (reverse proxy with WebSocket support)
