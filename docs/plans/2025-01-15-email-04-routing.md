# Email Module - Routing Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add email routing features including aliases, forwarding, spam filtering (SpamAssassin), and blacklist/whitelist management.

**Architecture:** Create `modules/email/postfix/routing.py` with functions to manage email aliases, forwarding rules, SpamAssassin integration, and sender restrictions.

**Tech Stack:** Python, Postfix, SpamAssassin
...
**Files:**
- Create: `modules/email/postfix/routing.py`
...
```bash
git add modules/email/postfix/routing.py
git commit -m "feat(email): add routing with aliases, forwards, spam filter"
```
...
Plan 04 complete. This adds comprehensive email routing features.
