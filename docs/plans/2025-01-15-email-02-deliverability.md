# Email Module - Deliverability Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add DKIM, SPF, and DMARC configuration to improve email deliverability and prevent emails from landing in spam.

**Architecture:** Create `modules/email/postfix/deliverability.py` with functions to install/configure OpenDKIM, generate DNS records for SPF/DMARC, and verify configurations.

**Tech Stack:** Python, OpenDKIM, Postfix, DNS TXT records

---

## Task 1: Create Deliverability Module

**Files:**
- Create: `modules/email/postfix/deliverability.py`

**Step 1: Create deliverability.py**
...
```bash
git add modules/email/postfix/deliverability.py
git commit -m "feat(email): add DKIM, SPF, DMARC deliverability config"
```
...
Plan 02 complete. This adds comprehensive email deliverability features.
