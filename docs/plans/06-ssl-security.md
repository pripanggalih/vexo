...
**Goal:** Implement SSL security auditing with quick checks, full SSL analysis, security headers audit, and recommendations.

**Architecture:** Use OpenSSL for local checks, SSL Labs API for comprehensive analysis, curl for headers check. Generate actionable recommendations.

**Tech Stack:** Python, Rich, OpenSSL CLI, SSL Labs API, curl

---

## Task 1: Implement Security Audit Module

**Files:**
- Modify: `modules/ssl/security.py`

**Step 1: Replace security.py with full implementation**
...
def get_recommendations():
    ...
    # Offer to generate Nginx config snippet
...
```bash
git add modules/ssl/security.py
git commit -m "feat(ssl): implement security audit with SSL Labs and headers check"
```
...
2. **Full SSL Audit works:**
   - Connects to SSL Labs API
   - Displays grade and details

3. **Security Headers works:**
   - Fetches and parses headers
   - Shows missing headers

4. **Recommendations works:**
