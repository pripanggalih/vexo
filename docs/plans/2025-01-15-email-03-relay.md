# Email Module - SMTP Relay Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add SMTP relay configuration to send emails through external providers like SendGrid, Amazon SES, Mailgun, or custom SMTP servers.

**Architecture:** Create `modules/email/postfix/relay.py` with functions to configure relay providers, manage per-domain relay profiles, and test connections.

**Tech Stack:** Python, Postfix, SASL authentication

---

## Task 1: Create Relay Module

**Files:**
- Create: `modules/email/postfix/relay.py`

**Step 1: Create relay.py**
...
```bash
git add modules/email/postfix/relay.py
git commit -m "feat(email): add SMTP relay configuration"
```
...
Plan 03 complete. This adds SMTP relay configuration with multi-provider support.
