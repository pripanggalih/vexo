# Fail2ban Phase 3: Ban Management + Permanent Bans

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Implement comprehensive ban management including list, ban, unban operations with permanent ban list support.

**Architecture:** Enhance ban operations with jail selection, permanent ban tracking in JSON file, and batch operations.

**Tech Stack:** Python, Rich (tables), fail2ban-client commands, JSON for permanent bans

---

## Task 1: Implement Ban Management Module

**Files:**
- Modify: `modules/fail2ban/bans.py`

**Step 1: Implement full bans.py**
...
def ban_ip_menu():
    ...
    # Optional: add to permanent list
    console.print()
...
def unban_ip_menu():
    ...
    # Option: unban from specific jail or all
...
**Step 2: Commit ban management**

```bash
git add modules/fail2ban/bans.py
git commit -m "feat(fail2ban): implement ban management with permanent ban list"
```
...
1. Ban management features:
   - List banned IPs (per jail or all)
   - Ban IP with optional permanent flag
   - Unban IP (single jail or all)
   - Permanent ban list with CRUD operations
   - Search IP across bans and history

2. Permanent bans stored in `~/.vexo/fail2ban/permanent_bans.json`

3. Apply permanent bans feature for system recovery
