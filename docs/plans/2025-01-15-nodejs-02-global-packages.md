# Node.js Global Packages Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add global npm packages management including list, install, update, remove, check outdated, and cache cleaning.

**Architecture:** Create `modules/runtime/nodejs/packages.py` with functions for managing global npm packages via NVM-sourced commands.

**Tech Stack:** Python, npm, NVM

**Dependency:** Requires `2025-01-15-nodejs-01-pm2.md` to be executed first (creates folder structure).

---

## Task 1: Create Global Packages Module

**Files:**
- Create: `modules/runtime/nodejs/packages.py`
...
```bash
git add modules/runtime/nodejs/packages.py
git commit -m "feat(runtime): add global npm packages management"
```
...
**Plan saved to:** `docs/plans/2025-01-15-nodejs-02-global-packages.md`

This plan covers:
- List Global Packages (with versions)
- Install Package (with popular presets)
